$(document).ready(function () {
    ...
    if (token) {
        ...
        if (window.localStorage.getItem('auth_role') === 'ROLE_USER') {
            $('.menu-ul').append('<li class="menu-ul-li-admin"><a href="user.html"' +
        ...
        if (window.localStorage.getItem('auth_role') === 'ROLE_ADMIN') {
            $('.menu-ul').append('<li class="menu-ul-li-admin"><a href="admin.html"' +
                'class="auth-red" style="color:red"><b>' + window.localStorage.getItem('userFirstName') + '</b></a></li>');
        }
    } else {
        $('.menu-ul').append('<li class="menu-ul-li-admin"><a href="signin.html"' +
