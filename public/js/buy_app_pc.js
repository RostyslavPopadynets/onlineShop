$(document).ready(function () {
            ...
            <div class="row">
                ...
                <div style="text-align:center" style="text-align:center" class="con_search" id="">
                    ...
                    <div id="mainn">
                        ...
                        <label class="mainn" style="text-align:center" info="Acer; ARTLINE ...">Виробник
                            <input type="text" class="form-control" id="manufacturer"></label>
                        <label class="mainn" style="text-align:center" info="Veriton N2510G; Gaming X79 v20 ...">Модель
                            <input type="text" class="form-control" id="model"></label>
                    </div><br>

                    <div id="memory">
                        <h4 id="memoryq">Пам'ять</h4>
                        <label class="memory" style="text-align:center" info="2 000; 512 ...(в Гігабайтах)">Влаштована
                ...
                <div id="other">
                    ...
                    <label class="other" style="text-align:center" info="Intel Core i7-7700 (3.6 - 4.2 ГГц); Intel Celeron J3060 ...">Процесор
                        <input type="text" class="form-control" id="processor"></label>
                    <label class="other" style="text-align:center" info="Intel HD Graphics 400;  nVidia GeForce GTX 1080 Ti, 11 ГБ ...">Відеокарта
                        <input type="text" class="form-control" id="graphicAdapter"></label>
                    <label class="other" style="text-align:center" info="без ОС; Windows 7 ...">Операційна система
                        <input type="text" class="form-control" id="os"></label>
                    <label class="other" style="text-align:center" info="MSI CORE FROZR L; BOX; 3 x 120-мм RGB куллера ...">Охолодження
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            getPCs(pageNumber, numberElementsOnPage);
            ...
            function Search() {
                ...
                if (manufacturer !== '' || model !== '' || driveCapacity !== ''
                    || ram !== '' || processor !== '' || os !== '' || graphicAdapter !== '' || cooling !== '' || price !== '') {
        ...
        function searchPCs(whatSearch, searchValue) {
            $.ajax({
                url: rootUrl + "pc/" + whatSearch + "/search?search=" + searchValue,
                method: 'GET',
                dataType: 'json',
                success: function (result) {
                    $('#productions').append('<h4 style="color:blue; text-align: right;">Знайдено комп\\'ютерів : ' + result.length + '<h4>');
        ...
        function getPCs(pageNumber, numberElementsOnPage) {
            $.ajax({
                url: rootUrl + "pc/pages?page=" + pageNumber + "&size=" + numberElementsOnPage,
                method: 'GET',
                dataType: 'json',
                success: function (result) {
