        ...
        <section class="containor-fluid" id="laptopForm">
            <div class="row">
                <div style="text-align:center" style="text-align:center" class="col-4 con_start" id="">
                    <h4>Ноутбук</h4>
                    <label style="text-align:center" info="HP; ASUS ...">Виробник*
                        <input type="text" class="form-control" id="manufacturer"></label>
                    <label style="text-align:center" info="Pavilion Power 15-cb038ur (3FY78EA); FX503VM-E4037 (90NR0GP1-M00950) ...">Модель*
                        <input type="text" class="form-control" id="model"></label>
                    <label style="text-align:center" info="15.6'' (1920x1080) Full HD ...">Діагональ дисплея*
                        <input type="text" class="form-control" id="diagonalScreen"></label>
                    <label style="text-align:center" info="Intel Core i5-7300HQ ...">Процесор*
                        <input type="text" class="form-control" id="processor"></label>
                    <h4>Пам'ять</h4>
                    <label style="text-align:center" info="1 000; 512 ...(в Гігабайтах)">Влаштована*
                    ...
                    <h4>Інше</h4>
                    <label style="text-align:center" info="nVidia GeForce GTX 1050, 4 ГБ;  nVidia GeForce GTX 1060, 3 ГБ ...">Відеокарта*
                        <input type="text" class="form-control" id="graphicAdapter"></label>
                    <label style="text-align:center" info="Литий-ионная, 4-ячеечная, 70 Вт*ч; 4-ячеечная, 64 Вт*ч">Потужність
                        батареї*
                        <input type="text" class="form-control" id="battery"></label>

                    <div id="photoLaptop">
                        <br><br><img style='width: 315px' src="../image/tvphoto.png" alt="laptop.png">
                        <hr>
                    </div>
                ...
                <div style="text-align:center" class="col-4 con_center" id="">
                    ...
                    <label style="text-align:center" info="2 500; 2 2000 ...(в грамах)">Вага
                        <input type="number" class="form-control" id="weight"></label>
                    <h4>Розміри</h4>
                    <label style="text-align:center" info="292 ; 384  ...(в міліметрах)">Ширина
                        <input type="number" class="form-control" id="dimensionsWidth"></label>
                    <label style="text-align:center" info="262; 224 ...(в міліметрах)">Висота
                        <input type="number" class="form-control" id="dimensionsHeight"></label>
                    <label style="text-align:center" info="24; 19 ...(в міліметрах)">Товщина
                    ...
                    <h4 class="label" info="Екран: (1920x1080) Full HD; Веб-камера HD, Встроєний мікрофон, Встроєні стереодинаміки ...">Доповнення</h4>
                    <label style="text-align:center" info="Екран: (1920x1080) Full HD; Веб-камера HD, Встроєний мікрофон, Встроєні стереодинаміки ...">
                ...
                <div style="text-align:center" class="col-3 con_end" id="">
                    ...
                    <br><img style='width: 320px' src="../image/lap.png" alt="laptop.png">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#photo5', function (e) {
                console.log("зчитано фото");
                uploadFile1(laptopId, 5);
                $(this).prop('disabled', true);
            });

            function uploadFile1(laptopId, photoNumber) {
                let formData = new FormData();
                formData.append('image', $('#photo' + photoNumber)[0].files[0]);

                $.ajax({
                    url: rootUrl + 'laptop/image/' + photoNumber + '/' + laptopId,
                    method: 'POST',
                    contentType: false,
                    data: formData,
                    processData: false,
            ...
            let next = '<h4 class="label" info="jpeg; png (бажаний розмір 500х500px). Оберіть хоча б 1 фото.">Фото ноутбука*</h4>' +
            ...
            function createLaptop() {
                ...
                if (firstName === '' || lastName === '' || email === '' || password === ''
                    || manufacturer === '' || model === '' || diagonalScreen === '' || processor === '' || driveCapacity === ''
                    || ram === '' || graphicAdapter === '' || battery === '' || color === ''
                    || price === '' || weight > 9999.99 || price > 999999.99 || dimensionsWidth > 9999.99 ||
                    dimensionsHeight > 9999.99 || dimensionsLength > 9999.99) {
                    $('.sell').html(err);
                } else {
                    let user = {
                        "firstName": firstName,
